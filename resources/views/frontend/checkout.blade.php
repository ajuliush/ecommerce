        ...
        <form name="checkout-form" action="{{ route('cart.place.order') }}" method="POST">
            ...
            <div class="checkout-form">
                <div class="billing-info__wrapper">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="my_account_address-list">
                                <div class="my_account_address-list-item">
                                    <div class="my_account_address-item-detail">
                                        <p>{{ $addresses->name }}</p>
                    ...
                    <div class="sticky-content">
                        ...
                        <div class="checkout__payment-methods">
                            <div class="form-check">
                                <input class="form-check-input form-check-input-fill" type="radio" id="mode1" name="mode" value="card">
                                <label class="form-check-label" for="mode1">Debit or credit card</label>
                            </div>

                            <div class="form-check">
                                <input class="form-check-input form-check-input-fill" type="radio" id="mode2" name="mode" value="paypal">
                                <label class="form-check-label" for="mode2">PayPal</label>
                            </div>

                            <div class="form-check">
                                <input class="form-check-input form-check-input-fill" type="radio" id="mode3" name="mode" value="cod">
                                <label class="form-check-label" for="mode3">Cash on delivery</label>
                            </div>
                            @error('mode') <span class="" style="color: #e31c0c !important;">{{ $message }}</span> @enderror
                        ...
                        <button type="submit" class="btn btn-primary">PLACE ORDER 88</button>
                    </div>
                </div>
            </div>
        </form>
