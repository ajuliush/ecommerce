                    ...
                    <div class="product-single__thumbnail">
                        <div class="swiper-container">
                            <div class="swiper-wrapper">
                                ...
                                @foreach (explode(',',$product->images) as $img)
                                <div class="swiper-slide product-single__image-item"><img loading="lazy" class="h-auto" src="{{ asset('uploads/products/thumbnails/'.$img) }}" width="104" height="104" alt="{{ $product->name }}" /></div>
                                @endforeach
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="swiper-slide product-card">
                        <div class="pc__img-wrapper">
                            <a href="{{ route('details', $item->slug) }}">
                                <img loading="lazy" src="{{asset('uploads/products/'.$item->image)}}" width="330" height="400" alt="{{ $product->name }}" class="pc__img">
                                @foreach (explode(',',$item->images) as $img)
                                <img loading="lazy" src="{{asset('uploads/products/'.$img)}}" width="330" height="400" alt="{{ $product->name }}" class="pc__img pc__img-second">
                                @endforeach
                            </a>
